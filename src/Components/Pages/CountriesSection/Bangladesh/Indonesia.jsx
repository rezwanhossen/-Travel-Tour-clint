...
const Indonesia = () => {
  ...
  return (
    <div>
      <div>
        <div className="hero min-h-screen  bg-[url('https://i.ibb.co/PYFcpWx/indos.jpg')] bg-cover h-[100vh]">
        ...
        <section className=" mt-10 space-y-4">
          <div className=" md:flex gap-4 border rounded p-5">
            <div className=" flex-1">
              <img
                ...
                src="https://i.ibb.co/PYFcpWx/indos.jpg"
                alt=""
              />
            </div>
            <div className=" flex-1">
          ...
          <div className=" md:flex gap-4 border rounded p-5">
            ...
            <div className=" flex-1">
              <img
                className=" w-full h-[300px]"
                src="https://i.ibb.co/4djhYD3/ind.jpg"
                alt=""
              />
            </div>
          </div>
