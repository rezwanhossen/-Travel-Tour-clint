...
const Cambodia = () => {
  ...
  useEffect(() => {
    fetch("https://assigment10-sarver-side.vercel.app/countrys/Cambodia")
      .then((res) => res.json())
      .then((data) => {
        setbcard(data);
      });
  ...
  return (
    <div>
      <div>
        <div className="hero min-h-screen  bg-[url('https://i.ibb.co/GkH07Yn/cambodia.jpg')] bg-cover h-[100vh]">
          <div className="hero-content text-center">
            <div className="max-w-md text-white">
              <h1 className="text-5xl font-bold">Cambodia</h1>
              <p className="py-6 text-xl">
                Welcome to Cambodia, Nestled in the heart of Southeast Asia lies
                a land of vibrant culture, rich history, and unparalleled
                natural beauty: Cambodia. From bustling metropolises to serene
          ...
          >
            <div className=" flex-1">
              <img
                ...
                src="https://i.ibb.co/n1XpsL4/Dollarphotoclub-73953575-2-scaled.jpg"
                alt=""
              />
            </div>
            <div className=" flex-1">
              ...
              <p>
                Cambodia boasts some of the most beautiful beaches in the world,
