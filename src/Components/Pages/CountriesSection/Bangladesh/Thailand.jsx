...
const Thailand = () => {
  ...
  useEffect(() => {
    fetch("https://assigment10-sarver-side.vercel.app/countrys/Thailand")
      .then((res) => res.json())
      .then((data) => {
        setbcard(data);
      });
  ...
  return (
    <div>
      <div className="hero min-h-screen  bg-[url('https://i.ibb.co/MpbfXKf/image.jpg')] bg-cover h-[100vh]">
        <div className="hero-content text-center">
          <div className="max-w-md">
            <h1 className="text-5xl font-bold">Thailand</h1>
            <p className="py-6 text-xl">
              Welcome to Thailand, Nestled in the heart of Southeast Asia lies a
              land of vibrant culture, rich history, and unparalleled natural
              beauty: Thailand. From bustling metropolises to serene islands,
              Thailand offers a diverse array of experiences that captivate the
              senses and leave a lasting impression on all who visit.
            </p>
          </div>
        </div>
      </div>
      ...
      <section className=" mt-10 space-y-4">
        ...
        >
          <div className=" flex-1">
            <img
              ...
              src="https://i.ibb.co/60zPpWH/fffs.jpg"
              alt=""
            />
          </div>
          <div className=" flex-1">
        ...
        >
          <div className=" flex-1">
            ...
            <p>
              Beyond the mainland, Thailand is home to numerous idyllic islands
              with lush jungles, clear waters, and vibrant coral reefs. From the
              party atmosphere of Koh Phangan to the tranquility of Koh Tao and
              the luxury resorts of Koh Samui, each island offers a unique
              experience for travelers seeking relaxation and adventure.
            </p>
          </div>
          <div className=" flex-1">
            <img
              className=" w-full h-[300px]"
              src="https://i.ibb.co/MpbfXKf/image.jpg"
              alt=""
            />
          </div>
        </div>
